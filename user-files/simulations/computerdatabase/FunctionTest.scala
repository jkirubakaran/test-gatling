...
class FunctionTest extends Simulation {
  ...
  val httpConf = http
    .baseURL("https://azfuncapptest-20180508164059550.azurewebsites.net") // Here is the root for all relative URLs
  ...
  setUp(scn.inject(constantUsersPerSec(20) during (300 seconds)).protocols(httpConf))
